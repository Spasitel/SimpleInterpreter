...
import com.jetbrains.simpleinterpreter.common.Position;
...
public class Editor extends JFrame {
    ...
    private void renderErrorWithPosition(String errorMessage, Position position) {
        ...
        if (startIndex >= text.length()) {
            resultArea.append("Error at EOF: " + errorMessage);
        } else {
            resultArea.append("Error at line " + position.getLineAndPosition(text) + " " + errorMessage);
